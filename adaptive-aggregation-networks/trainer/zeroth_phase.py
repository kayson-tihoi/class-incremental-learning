...
def incremental_train_and_eval_zeroth_phase(the_args, epochs, b1_model, ref_model, \
    ...
    lamda, dist, K, lw_mr, fix_bn=False, weight_per_class=None, device=None, logger=None):
    ...
    for epoch in range(epochs):
        ...
        logger_fn('Train set: {}, train loss: {:.4f} accuracy: {:.4f}'.format(len(trainloader), train_loss/(batch_idx+1), 100.*correct/total))
